...
const leakCards = [
  ...
  },
  {
    ...
    description:
      "Without a smart system, interested buyers just ghost you the second you send a link.",
  },
  {
    step: "03",
    title: "NURTURE",
    ...
    description:
      "Most big clients buy after 30 to 90 days. If you don't follow up automatically, they are gone forever.",
  },
  {
    step: "04",
    title: "BOOKING",
    ...
    description:
      "A bad booking process scares away real buyers and lets broke people waste your time.",
  },
  {
    step: "05",
    title: "FOLLOW UP",
    ...
    description:
      "If you don't automatically follow up, you are leaving massive amounts of money on the table.",
  },
];
    ...
    <section id="leaks" className="scroll-mt-24 border-t border-line py-20 px-5 sm:px-8">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mx-auto mb-12 max-w-xl text-center text-xs text-muted-foreground">
          You can have all the followers in the world and still lose high ticket clients if your
          system is broken.
        </p>
        ...
        <div className="mx-auto flex max-w-2xl flex-col sm:flex-row items-center justify-center gap-2 rounded-2xl border border-accent/20 bg-accent-soft p-4 text-center text-xs font-medium text-foreground">
          <span>
            Most coaches don't have one giant problem. They have several small leaks across the
            client journey. That's what we fix with the DUXIO Client Acquisition System.
          </span>
        </div>
      </div>
    </section>
